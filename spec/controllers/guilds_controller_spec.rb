...
RSpec.describe GuildsController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all guilds as @guilds" do
      ...
      expect(assigns(:guilds)).to eq([guild])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested guild as @guild" do
      guild = Guild.create! valid_attributes
      get :show, {:id => guild.to_param}, valid_session
      expect(assigns(:guild)).to eq(guild)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new guild as @guild" do
      ...
      expect(assigns(:guild)).to be_a_new(Guild)
    end
  end
  ...
  describe "GET edit" do
    it "assigns the requested guild as @guild" do
      guild = Guild.create! valid_attributes
      get :edit, {:id => guild.to_param}, valid_session
      expect(assigns(:guild)).to eq(guild)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Guild" do
        expect {
          post :create, {:guild => valid_attributes}, valid_session
        }.to change(Guild, :count).by(1)
      end

      it "assigns a newly created guild as @guild" do
        post :create, {:guild => valid_attributes}, valid_session
        expect(assigns(:guild)).to be_a(Guild)
        expect(assigns(:guild)).to be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved guild as @guild" do
        post :create, {:guild => invalid_attributes}, valid_session
        expect(assigns(:guild)).to be_a_new(Guild)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested guild" do
        guild = Guild.create! valid_attributes
        put :update, {:id => guild.to_param, :guild => new_attributes}, valid_session
        guild.reload
      ...
      it "assigns the requested guild as @guild" do
        guild = Guild.create! valid_attributes
        put :update, {:id => guild.to_param, :guild => valid_attributes}, valid_session
        expect(assigns(:guild)).to eq(guild)
      end
    ...
    describe "with invalid params" do
      it "assigns the guild as @guild" do
        guild = Guild.create! valid_attributes
        put :update, {:id => guild.to_param, :guild => invalid_attributes}, valid_session
        expect(assigns(:guild)).to eq(guild)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested guild" do
      guild = Guild.create! valid_attributes
      expect {
        delete :destroy, {:id => guild.to_param}, valid_session
      }.to change(Guild, :count).by(-1)
    end
